...
function mvc_inicio(){
    ...
    $url_actualizacion = 'https://adminxp.xonastore.com/version.php?tipo=actualizacion&v='.$version_local;
    ...
    $archivo = 'https://adminxp.xonastore.com/versiones/'.$version_actualizar.'.zip';
