<?php include(__DIR__ . '/header.php'); ?>
				<div class="container-fluid">
					<div class="panel">
						...
						<form method="post" action="<?php echo $mvctemplate['url']; ?>/?do=uploadvideo" enctype="multipart/form-data">
								...
								<div class="row">
										...
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" type="file" name="archivo_mp4" required>
											</div>
										</div>									
